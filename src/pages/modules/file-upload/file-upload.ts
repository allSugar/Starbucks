...
import { IonicPage, normalizeURL, NavController, NavParams, ViewController, ToastController, LoadingController, ActionSheetController, Platform } from 'ionic-angular';
...
export class FileUploadPage extends BaseUI {
